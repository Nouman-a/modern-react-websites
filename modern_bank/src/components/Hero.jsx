    ...
    >
      ...
      >
        ...
        <p className={`${styles.paragraph}`}>
          <span className="text-white">20%</span> Discout For{" "}
      ...
      <h1 className="font-poppins font-semibold ss:text-[68px] text-[52px] w-full text-white ss:leading-[100px]">  Payment Method.
      </h1>
